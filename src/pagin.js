...
const Pagin = () => {
 ...
 useEffect(() => {
    ...
    fetch_employee(); 
  }, []); // it will run only once due to empty dependence array
  ...
  style={{
    ...
    minWidth: "30px",
    textAlign: "center",
    display: "inline-block", // ensures padding & border work properly
  }}
>
  <h1 style={{ margin: 0, fontSize: "16px" }}>{currPage}</h1>
</span>
